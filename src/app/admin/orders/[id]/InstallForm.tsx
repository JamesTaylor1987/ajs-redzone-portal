...
export function InstallForm({ quoteId, installQuoteSent, installStage }: Props) {
    ...
    <div className="bg-white rounded-xl border border-ajs-light p-5">
      ...
      <form action={action} className="space-y-4">
        ...
        <div className="space-y-3">
          {/* Requested — read-only, set by customer */}
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-emerald-700">Requested by customer</span>
          </div>
